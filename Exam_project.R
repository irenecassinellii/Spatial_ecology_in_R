...
# This project aims to study the decrease in vegetation cover in the Amazon rainforest caused by deforestation between 2000, 2006, and 2012
...
amazon2006 <- brick("Amazon2006.jpg")
amazon2012 <- brick("Amazon2012.jpg")

# Use the function par() to arrange the three graphs in a 3x1 grid (i.e., one below the other)
par(mfrow=c(3,1))
plotRGB(amazon2000, r=1, g=2, b=3)
plotRGB(amazon2006, r=1, g=2, b=3)
...
img2006 <- image_read("Amazon2006.jpg")
...
img2006_cropped <- image_crop(img2006, geometry = paste0(width, "x", height, "+", x1, "+", y1))
...
image_write(img2006_cropped, path = "Amazon2006.jpg")
